...
Even for single-expression closures where the context is clear, use explicit
returns:
...
Prefer the struct-scope constants `CGRect.infinite`, `CGRect.null`, etc. over
